...
function App() {
  ...
  return (
    <div className="font-body text-slate-800 antialiased overflow-x-hidden relative">
      ...
      <footer className="relative z-10 bg-white/10 backdrop-blur-xl text-white py-8 text-center border-t border-white/15">
        <p className="text-white/40 font-medium text-sm">© {new Date().getFullYear()} · Made with ❤️ by Angga Stwn</p>
      </footer>
    </div>
  );
}
